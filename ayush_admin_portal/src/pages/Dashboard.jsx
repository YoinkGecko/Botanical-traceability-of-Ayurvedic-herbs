...
import { Users, Settings, LogOut, Shield, Database, UserCheck, UserX, Activity } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const stats = [
    { label: 'Active Admins', value: '24', icon: UserCheck, color: 'text-green-600' },
    { label: 'Suspended Admins', value: '3', icon: UserX, color: 'text-red-600' },
    { label: 'Total Transactions', value: '1,456', icon: Database, color: 'text-blue-600' },
    { label: 'System Alerts', value: '5', icon: Shield, color: 'text-orange-600' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Ministry of Ayush</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="space-y-4">
            {[
              { action: 'New admin registered', time: '2 minutes ago', type: 'success' },
              { action: 'Blockchain transaction verified', time: '15 minutes ago', type: 'info' },
              { action: 'Security alert resolved', time: '1 hour ago', type: 'warning' },
